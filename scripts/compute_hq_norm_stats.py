...
sampled_train_df = pd.read_csv(os.path.join(dataset_dir, "sampled_hq_train_eegs.csv"))
...
plot_eeg_histograms_with_gaussian(filtered_eeg_windows_df, f"../scripts/filtered_{int(highcut)}Hz_hq_EEG_windows_histograms_with_gaussian_fit.png")
